...
def get_combined_peak():
    ...
    peak_list = list()
    for df in [k562_rep1, k562_rep2, k562_rep3, k562_rep4, k562_rep5, mcf7_rep1, mcf7_rep2, mcf7_rep3, mcf7_rep4, mcf7_rep5]:
    ...
    with open("chipseq_k562_mcf7_combined_peak.bed", "w") as f:
        for peak in combined_peak:
    ...
    signalValue_k562_rep5 = get_signalValue(k562_rep5, combined_peak)
    ...
    signalValue_mcf7_rep5 = get_signalValue(mcf7_rep5, combined_peak)

    signalValue_matrix = [signalValue_k562_rep1, signalValue_k562_rep2, signalValue_k562_rep3, signalValue_k562_rep4, signalValue_k562_rep5, signalValue_mcf7_rep1, signalValue_mcf7_rep2, signalValue_mcf7_rep3, signalValue_mcf7_rep4, signalValue_mcf7_rep5]
    ...
    signalValue_matrix = pd.DataFrame(signalValue_matrix, columns=['K562_REP1', 'K562_REP2', 'K562_REP3', 'K562_REP4', 'K562_REP5', 'MCF7_REP1', 'MCF7_REP2', 'MCF7_REP3', 'MCF7_REP4', 'MCF7_REP5'])
    signalValue_matrix.to_csv('./chipseq_k562_mcf7_signalValue_matrix.csv', sep=',', header=True, index=True)

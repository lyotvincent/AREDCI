...
if __name__ == '__main__':
    ...
    K562_MCF7_RNA_EXP_FILE = os.path.join(ROOT_DIR, 'data', 'RNA_expression', 'K562_MCF7_exp_matrix.csv')
    K562_MCF7_RNA_EXP_NORM_SF_FILE = os.path.join(ROOT_DIR, 'data', 'RNA_expression', 'K562_MCF7_pvalues.csv')

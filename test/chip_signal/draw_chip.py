...
k562_rep1_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'K562', 'ENCFF221SKA.bed')
k562_rep2_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'K562', 'ENCFF582SNT.bed')
k562_rep3_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'K562', 'ENCFF660GHM.bed')
k562_rep4_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'K562', 'ENCFF736NYC.bed')
k562_rep5_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'K562', 'ENCFF769AUF.bed')
mcf7_rep1_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'MCF7', 'ENCFF138LHE.bed')
mcf7_rep2_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'MCF7', 'ENCFF163JHE.bed')
mcf7_rep3_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'MCF7', 'ENCFF278FNP.bed')
mcf7_rep4_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'MCF7', 'ENCFF542DEP.bed')
mcf7_rep5_path = os.path.join(ROOT_PATH, 'data', 'CTCF_ChIP_seq', 'MCF7', 'ENCFF596MGE.bed')
...
def draw_bar(x,y,name,format):
    OUT_PATH = os.path.join(ROOT_PATH, 'test', 'chip_signal', f'{name}.{format}')
...
add_ocr_to_y_k562(k562_rep5_path)
...
add_ocr_to_y_mcf7(mcf7_rep5_path)
...
draw_bar(x, y_dif, 'k562_mcf7_chip_diff', 'pdf')
